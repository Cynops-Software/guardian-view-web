...
const Header = styled.header`
  background: linear-gradient(to right, #99b6d5, #465d98);
  padding: 2rem 1rem;
  text-align: center;
  border-radius: 8px;
  margin-bottom: 2rem;
    ...
    <>
      <PageWrapper>
        ...
        <List>
          ...
          <li>
            <strong>Application</strong>refers to Guardian View, the software
            program provided by the Company.
          </li>
          <li>
            <strong>Company</strong>(referred to as either "the Company", "We",
            "Us" or "Our" in this Agreement) refers to Guardian View
          </li>
          <li>
          ...
          <li>
            <strong>You</strong>: You means the individual accessing or using
        ...
        <Text>The Company uses Personal Data for:</Text>
        <List>
          <li>
        ...
        <SectionTitle>Other legal requirements</SectionTitle>
        <Text>
